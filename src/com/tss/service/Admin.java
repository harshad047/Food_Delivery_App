...
public class Admin {
    ...
    public Admin(Scanner scanner, FoodMenuFactory foodMenuFactory, IDiscountManager discountManager, DeliveryPartnerManager deliveryPartnerManager) {
    ...
    private void manageDiscount() {
        ...
        while (!back) {
            ...
            switch (choice1) {
                ...
                case 3 -> System.out.println("Regular Discount: " + ((DiscountManager) discountManager).getRegularDiscount().getDiscountPercentage() + "%");
                case 4 -> back = true;
                default -> System.out.println("Invalid choice.");
            }
        }
